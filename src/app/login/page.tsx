...
import { Phone, IdCard, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (loginType === 'phone') {
        ...
        // 핀번호 로그인 로직 (임시로 admin123으로 처리)
        if (formData.pinCode === '1234') {
          // 핀번호가 1234인 경우 관리자로 로그인
          await auth.signInWithPhone('010-6669-9000', 'admin123');
        } else {
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-indigo-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="mt-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
          <h4 className="text-sm font-medium text-blue-900 mb-2">로그인 안내</h4>
