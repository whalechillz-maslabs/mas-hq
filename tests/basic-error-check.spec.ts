...
test('기본 에러 확인 테스트', async ({ page }) => {
  console.log('🔍 기본 에러 확인 테스트 시작');
  ...
  // 12. 스크린샷 캡처
  await page.screenshot({ path: 'basic-error-check.png', fullPage: true });
  console.log('✅ 기본 에러 확인 테스트 스크린샷 캡처 완료');
  
  console.log('🎉 기본 에러 확인 테스트 완료!');
});
