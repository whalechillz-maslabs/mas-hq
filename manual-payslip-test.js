...
async function manualPayslipTest() {
    console.log('🧪 최형호 급여명세서 수동 테스트');
    ...
    try {
        ...
        // 4. 수동으로 년도와 월 선택 (JavaScript 실행)
        console.log('4. JavaScript로 년도와 월 선택...');
        await page.evaluate(() => {
            // 년도 선택
        ...
        // 7. 스크린샷 저장
        await page.screenshot({ path: 'payslip-test-manual.png', fullPage: true });
        console.log('📸 스크린샷 저장: payslip-test-manual.png');
        
        // 8. 30초 대기 (수동 확인용)
        console.log('8. 30초 대기 (수동 확인용)...');
